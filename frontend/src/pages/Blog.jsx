...
const Blog = () => {
    ...
    useEffect(() => {
        const getAllPublsihedBlogs = async () => {
            try {
                const res = await axios.get(`https://mern-blog-website1-tpd1.onrender.com/api/v1//blog/get-published-blogs`, { withCredentials: true })
                if (res.data.success) {
    ...
    return (
        <div className='pt-16'>
            <div className='flex flex-col items-center max-w-6xl mx-auto space-y-4 text-center'>
                <h1 className='pt-10 text-4xl font-bold text-center '>Our Blogs</h1>

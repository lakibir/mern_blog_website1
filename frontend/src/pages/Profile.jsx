    ...
    return (
        <div className='pt-20 md:ml-[320px] md:h-screen'>
            <div className='max-w-6xl mx-auto mt-8 '>
                <Card className="flex flex-col gap-10 p-6 mx-4  md:flex-row md:p-10 dark:bg-gray-800 md:mx-0">
                    {/* image section */}
                    <div className='flex flex-col items-center justify-center md:w-[400px]'>
                        <Avatar className="w-40 h-40 border-2">
                            <AvatarImage src={user?.photoUrl || userLogo} />
                        </Avatar>
                        <h1 className='my-3 text-xl font-semibold text-center text-gray-700 dark:text-gray-300'>{user?.occupation || "Mern Stack Developer"}</h1>
                    ...
                    {/* info section */}
                    <div>
                        <h1 className='text-4xl font-bold text-center md:text-start mb-7'>Welcome {user?.firstName}!</h1>
                        ...
                        <div className='flex flex-col items-start justify-start gap-2 my-5'>
                            ...
                            <p className='p-6 border rounded-lg dark:border-gray-600'>{user?.bio || "I'm a passionate web developer and content creator focused on frontend technologies. When I'm not coding, you can find me writing about tech, hiking, or experimenting with new recipes."}</p>
                        ...
                        <Dialog open={open} onOpenChange={setOpen} >
                            ...
                            <DialogContent className="md:w-[425px] ">
                                ...
                                <DialogFooter>
                                    {
                                        loading ? <Button ><Loader2 className='w-4 h-4 mr-2 animate-spin' /> Please wait</Button> : <Button

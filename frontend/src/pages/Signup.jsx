...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://mern-blog-website1-tpd1.onrender.com/api/v1//user/register`, user, {
                headers: {
            ...
            <div className='flex items-center justify-center flex-1 px-4 md:px-0'>
                <Card className="w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600">
                    <CardHeader>
                        ...
                        <p className='mt-2 font-serif text-sm text-center dark:text-gray-300'>Enter your details below to create your account</p>
                    </CardHeader>
                    <CardContent>

...
const CreateBlog = () => {
    ...
    const createBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.post(`https://mern-blog-website1-tpd1.onrender.com/api/v1//blog/`, { title, category }, {
                headers: {
            ...
            <div className='mt-10 '>
                ...
                <div className='flex gap-2'>
                    ...
                    <Button className="" disabled={loading} onClick={createBlogHandler}>
                        {
                            loading ? <><Loader2 className='w-4 h-4 mr-1 animate-spin' />Please wait</> : "Create"
                        }
                    </Button>
                </div>
            </div>

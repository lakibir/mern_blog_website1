...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://mern-blog-website1-tpd1.onrender.com/api/v1//user/login`, input, {
        headers: {
  ...
  return (
    <div className="flex items-center h-screen md:pt-14 md:h-[760px] ">
      ...
      <Card className="w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-center">Login into your account</CardTitle>
          <p className='mt-2 font-serif text-sm text-center text-gray-600 dark:text-gray-300'>Enter your details below to login your account</p>
        </CardHeader>
        <CardContent>

...
const Navbar = () => {
    ...
    const logoutHandler = async (e) => {
        ...
        try {
            const res = await axios.get(`https://mern-blog-website1-tpd1.onrender.com/api/v1//user/logout`, { withCredentials: true });
            if (res.data.success) {
                navigate("/")
    ...
    return (
        <div className='fixed z-50 w-full py-2 bg-white border-2 dark:bg-gray-800 dark:border-b-gray-600 border-b-gray-300'>
            <div className='flex items-center justify-between px-4 mx-auto max-w-7xl md:px-0'>
                ...
                <div className='flex items-center gap-7'>
                    <Link to={'/'}>
                        <div className='flex items-center gap-2'>
                            ...
                            <h1 className='text-3xl font-bold md:text-4xl'>Logo</h1>
                        </div>
                    </Link>
                    <div className='relative hidden md:block'>
                        ...
                        />
                        <Button className='absolute top-0 right-0' onClick={handleSearch}><Search /></Button>
                    </div>
                </div>
                {/* nav section */}
                <nav className='flex items-center gap-4 md:gap-7'>
                    ...
                    <div className='flex'>
                        ...
                        {
                            user ? <div className="flex items-center gap-3 ml-7">
                                {/* <Link to={'/profile'}> */}
                            ...
                            </div> : <div className='gap-2 ml-7 md:flex '>
